...
# Flag Mapping Helper (Supports auto-flag generation for common codes and dynamic fallback)
FLAG_MAP = {
    "india": "🇮🇳", "in": "🇮🇳",
    "bangladesh": "🇧🇩", "bd": "🇧🇩",
    "indonesia": "🇮🇩", "id": "🇮🇩",
...
def get_flag(country_name: str) -> str:
    ...
    # Dynamic ISO alpha-2 country code flag generator
...
async def callback_router(client: Client, query: CallbackQuery):
    ...
    # ==================== DEPOSIT MODE CHOICE (INC. USDT/CRYPTO) ====================
    ...
    # ==================== COUNTRY & STOCK NAVIGATION FLOW (EXACT SS MATCH UI) ====================
        ...
        for c in countries:
            ...
            # Exact format matching the provided screenshot UI
